...
CREATE TABLE IF NOT EXISTS tb_front (
  ...
  agency varchar(32) DEFAULT NULL COMMENT '所属机构名称',
  client_version varchar(32) DEFAULT NULL COMMENT '节点版本（国密/非国密）',
...
CREATE TABLE IF NOT EXISTS tb_front_group_map (
  ...
  group_id varchar(255) NOT NULL COMMENT '群组编号',
  create_time datetime DEFAULT NULL COMMENT '创建时间',
  modify_time datetime DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE IF NOT EXISTS tb_node (
  node_id varchar(250) NOT NULL  COMMENT '节点编号',
  group_id varchar(255) NOT NULL COMMENT '所属群组编号',
...
CREATE TABLE IF NOT EXISTS tb_user (
  ...
  account varchar(50) binary DEFAULT 'admin' COMMENT '关联账号',
  group_id varchar(255) DEFAULT NULL COMMENT '所属群组编号',
...
CREATE TABLE IF NOT EXISTS tb_abi (
  ...
  account varchar(50) binary DEFAULT 'admin' COMMENT '关联账号',
  group_id varchar(255) NOT NULL COMMENT '合约ABI所属群组的编号',
