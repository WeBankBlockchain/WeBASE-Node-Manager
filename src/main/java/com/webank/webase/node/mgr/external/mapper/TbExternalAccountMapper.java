...
public interface TbExternalAccountMapper {
    ...
    List<RspAllExtAccount> listAccountJoinTbUser(@Param("param") UserParam param);
    ...
    List<TbExternalAccount> listExtAccount(@Param("param") UserParam param);

    @SelectProvider(type = TbExternalAccountSqlProvider.class, method = "count")
    int countExtAccount(@Param("param") UserParam param);
    ...
    int insertSelective(@Param("record") TbExternalAccount record);
    ...
    TbExternalAccount selectByPrimaryKey(@Param("id") Integer id);
    ...
    int updateByPrimaryKeySelective(@Param("record") TbExternalAccount record);
