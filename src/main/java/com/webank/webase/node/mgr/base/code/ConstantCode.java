...
public class ConstantCode {
    ...
    // add in v1.4.0
    public static final RetCode NO_DOCKER_TAG_UPDATE_URL_ERROR = RetCode.mark(202001, "No docker image tag update url.");
    public static final RetCode UPDATE_DOCKER_TAG_ERROR = RetCode.mark(202002, "Update docker tag from registry error.");
    public static final RetCode UNKNOWN_CONFIG_TYPE_ERROR = RetCode.mark(202003, "Unknown config type.");
    public static final RetCode SAVE_IP_CONFIG_FILE_ERROR = RetCode.mark(202004, "Save IP config error.");
    public static final RetCode TAG_ID_PARAM_ERROR = RetCode.mark(202005, "Tag id param error.");
    public static final RetCode IP_CONF_PARAM_NULL_ERROR = RetCode.mark(202006, "ipconf null.");
    public static final RetCode CHAIN_NAME_EXISTS_ERROR = RetCode.mark(202007, "Chain name exists.");
    public static final RetCode INSERT_CHAIN_ERROR = RetCode.mark(202008, "Insert new chain failed.");
    public static final RetCode NO_CONFIG_FILE_ERROR = RetCode.mark(202009, "No ipconf file.");
    public static final RetCode EXEC_BUILD_CHAIN_ERROR = RetCode.mark(202010, "Exec build chain script failed.");
    public static final RetCode IP_CONFIG_LINE_ERROR = RetCode.mark(202011, "ipconf line error.");
    public static final RetCode IP_NUM_ERROR = RetCode.mark(202012, "IP and num config error.");
    public static final RetCode AGENCY_NAME_CONFIG_ERROR = RetCode.mark(202013, "Agency name config error.");
    public static final RetCode GROUPS_CONFIG_ERROR = RetCode.mark(202014, "Groups config error.");
    public static final RetCode HOST_CONNECT_ERROR = RetCode.mark(202015, "Connect to host error.");
    public static final RetCode INSERT_AGENCY_ERROR = RetCode.mark(202016, "Insert new agency failed.");
    public static final RetCode INSERT_GROUP_ERROR = RetCode.mark(202017, "Insert new group failed.");
    public static final RetCode INSERT_HOST_ERROR = RetCode.mark(202018, "Insert new host failed.");
    public static final RetCode INSERT_FRONT_ERROR = RetCode.mark(202019, "Insert new front failed.");
    public static final RetCode INSERT_NODE_ERROR = RetCode.mark(202020, "Insert new node failed.");
    public static final RetCode INSERT_FRONT_GROUP_ERROR = RetCode.mark(202021, "Insert new front node group failed.");
    public static final RetCode PARSE_HOST_INDEX_ERROR = RetCode.mark(202022, "Parse host index from node directory failed.");
    public static final RetCode HOST_ONLY_BELONGS_ONE_AGENCY_ERROR = RetCode.mark(202023, "A host only belongs to one agency.");
    public static final RetCode DEPLOY_WITH_UNKNOWN_EXCEPTION_ERROR = RetCode.mark(202024, "Unexpected exception occurred when deploy.");
    public static final RetCode UNSUPPORTED_PASSWORD_SSH_ERROR = RetCode.mark(202025, "SSH password login not supported yet.");
    public static final RetCode CHAIN_WITH_NO_AGENCY_ERROR = RetCode.mark(202026, "Chain has no agency.");
    public static final RetCode CHAIN_NAME_NOT_EXISTS_ERROR = RetCode.mark(202027, "Chain name not exists.");
    public static final RetCode IP_FORMAT_ERROR = RetCode.mark(202028, "IP format error.");
    public static final RetCode AGENCY_NAME_EMPTY_ERROR = RetCode.mark(202029, "Agency name is null when host ip is new.");
    public static final RetCode AGENCY_NAME_EXISTS_ERROR = RetCode.mark(202030, "Agency name exists when host ip is new.");
    public static final RetCode ADD_NODE_WITH_UNKNOWN_EXCEPTION_ERROR = RetCode.mark(202031, "Unexpected exception occurred when add new node.");
    public static final RetCode CHAIN_CERT_NOT_EXISTS_ERROR = RetCode.mark(202032, "Chain cert directory not exists.");
    public static final RetCode EXEC_GEN_AGENCY_ERROR = RetCode.mark(202033, "Exec generate agency script failed.");
    public static final RetCode HOST_WITH_NO_AGENCY_ERROR = RetCode.mark(202034, "Host's agency is null.");
    public static final RetCode NODES_NUM_ERROR = RetCode.mark(202035, "Num should be positive integer and less then 4.");
    public static final RetCode EXEC_GEN_SDK_ERROR = RetCode.mark(202036, "Exec generate node script to generate sdk dir failed.");
    public static final RetCode EXEC_GEN_NODE_ERROR = RetCode.mark(202037, "Exec generate node script to generate node dir failed.");
    public static final RetCode COPY_SDK_FILES_ERROR = RetCode.mark(202038, "Copy sdk config files error.");
    public static final RetCode SEND_SDK_FILES_ERROR = RetCode.mark(202039, "Send sdk config files error.");
    public static final RetCode SEND_NODE_FILES_ERROR = RetCode.mark(202040, "Send node config files error.");
    public static final RetCode COPY_GROUP_FILES_ERROR = RetCode.mark(202041, "Copy original group config files error.");
    public static final RetCode DELETE_OLD_AGENCY_DIR_ERROR = RetCode.mark(202042, "Delete old agency config files error.");
    public static final RetCode DELETE_OLD_SDK_DIR_ERROR = RetCode.mark(202043, "Delete old sdk of host config files error.");
    public static final RetCode DELETE_OLD_NODE_DIR_ERROR = RetCode.mark(202044, "Delete old node config files error.");
    public static final RetCode NODE_ID_NOT_EXISTS_ERROR = RetCode.mark(202045, "Nodeid not exists.");
    public static final RetCode STOP_NODE_ERROR = RetCode.mark(202046, "Stop node failed.");
    public static final RetCode START_NODE_ERROR = RetCode.mark(202047, "Start node failed.");
    public static final RetCode UPGRADE_WITH_SAME_TAG_ERROR = RetCode.mark(202048, "New image tag and current are the same.");
    public static final RetCode UPDATE_CHAIN_WITH_NEW_VERSION_ERROR = RetCode.mark(202049, "Update chain version error.");
    public static final RetCode NODE_IN_GROUP_ERROR = RetCode.mark(202050, "Node still in group, remove before deleting.");
    public static final RetCode READ_NODE_CONFIG_ERROR = RetCode.mark(202051, "Read node config error.");
    public static final RetCode DELETE_NODE_DIR_ERROR = RetCode.mark(202052, "Delete node config files error.");
    public static final RetCode NODE_RUNNING_ERROR = RetCode.mark(202053, "Node is running.");
    public static final RetCode UPDATE_RELATED_NODE_ERROR = RetCode.mark(202054, "Update related nodes error.");
    public static final RetCode DELETE_CHAIN_ERROR = RetCode.mark(202055, "Delete chain error.");
    public static final RetCode NODE_NEED_REMOVE_FROM_GROUP_ERROR = RetCode.mark(202056, "Node is sealer or observer, remove from group first.");
    public static final RetCode LIST_HOST_NODE_DIR_ERROR = RetCode.mark(202057, "List node dirs of host error.");
    public static final RetCode GENERATE_FRONT_YML_ERROR = RetCode.mark(202058, "Generate front application.yml file failed.");
    public static final RetCode EXEC_HOST_INIT_SCRIPT_ERROR = RetCode.mark(202059, "Exec host init script failed.");
    public static final RetCode TRANSFER_FILES_ERROR = RetCode.mark(202060, "Transfer files error.");
    public static final RetCode DOCKER_OPERATION_ERROR = RetCode.mark(202061, "Docker option error.");
    public static final RetCode TWO_NODES_AT_LEAST = RetCode.mark(202062, "Two nodes at least.");
    public static final RetCode TWO_SEALER_IN_GROUP_AT_LEAST = RetCode.mark(202063, "Group need two sealers at least.");
    public static final RetCode WEBASE_SIGN_CONFIG_ERROR = RetCode.mark(202064, "Please check webaseSignAddress in application.yml file.");
    public static final RetCode UNKNOWN_DOCKER_IMAGE_TYPE = RetCode.mark(202065, "Docker image type param error.");
    public static final RetCode IMAGE_NOT_EXISTS_ON_HOST = RetCode.mark(202066, "Image not exists on host.");
    public static final RetCode NODES_NUM_EXCEED_MAX_ERROR = RetCode.mark(202067, "Max 4 nodes on a same host.");
    public static final RetCode SAME_HOST_ERROR = RetCode.mark(202068, "Cannot install node and WeBASE-Node-Manager on same host.");
