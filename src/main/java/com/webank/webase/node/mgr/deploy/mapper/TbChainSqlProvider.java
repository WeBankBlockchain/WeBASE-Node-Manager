...
public class TbChainSqlProvider {
     ...
     * @mbg.generated
     */
    public static final String ALL_COLUMN_FIELDS = "id,chain_name,chain_desc,version,encrypt_type,chain_status,run_type,create_time,modify_time,webase_sign_addr,user_id,dept_id";
