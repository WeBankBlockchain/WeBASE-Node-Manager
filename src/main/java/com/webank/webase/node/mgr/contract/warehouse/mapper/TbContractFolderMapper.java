...
public interface TbContractFolderMapper {
    ...
    int insertSelective(@Param("record") TbContractFolder record);
    ...
    TbContractFolder selectByPrimaryKey(@Param("id") Integer id);
    ...
    int updateByPrimaryKeySelective(@Param("record") TbContractFolder record);
