 ...
 * the License.
 */
package com.webank.webase.node.mgr.lite.front.frontgroupmap;
...
import com.webank.webase.node.mgr.lite.group.GroupMapper;
...
public class FrontGroupMapService {
    ...
    public void newFrontGroup(TbFront front, Integer groupId) {
        ...
        BaseResponse res = frontInterface.operateGroup(front.getFrontIp(), front.getFrontPort(),
                groupId, GroupService.OPERATE_STATUS_GROUP);
        ...
        if (res.getCode() == 0) {
            ...
            if (GroupService.RUNNING_GROUP.equals(groupStatus)) {
