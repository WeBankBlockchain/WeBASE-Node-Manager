...
package com.webank.webase.node.mgr.rpc.authmanager;

import com.webank.webase.node.mgr.base.code.ConstantCode;
import com.webank.webase.node.mgr.base.entity.BasePageResponse;
import com.webank.webase.node.mgr.base.exception.NodeMgrException;
import com.webank.webase.node.mgr.front.frontinterface.FrontRestTools;
import com.webank.webase.node.mgr.rpc.authmanager.base.entity.PermissionParam;
import com.webank.webase.node.mgr.rpc.authmanager.base.entity.PermissionState;
...
/**
    ...
    // 加上无权限的address(user)
    public Map<String, PermissionState> listPermissionState(String groupId) {
    ...
    public Map<String, PermissionState> listPermissionStateFull(String groupId) {
...
/**
    ...
    public Object listPermissionPaged(String groupId, String permissionType, String tableName, int pageSize, int pageNumber) {
...
/**
    ...
    public BasePageResponse listPermissionFull(String groupId, String permissionType, String tableName) {
...
/**
    ...
    public Object updatePermissionState(PermissionParam permissionParam) {
        ...
        String groupId = permissionParam.getGroupId();
