...
public class ParseToolTest extends TestBase {

    @Autowired
    ConsensusServiceInWebase consensusServiceInWebase;
    ...
    public void testParseResponseFromFromt() {
        ...
        Object responseFromFront = consensusServiceInWebase.getNodeListService(groupId, 100, 1);
